...
public class TouchImageView extends ImageView {
    ...
    public static class ScaleTypeArr {
    ...
    public class ScaleListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        public void onScaleEnd(ScaleGestureDetector scaleGestureDetector) {
            ...
            if (z) {
                TouchImageView touchImageView = TouchImageView.this;
                touchImageView.compatPostOnAnimation(new DoubleTapZoom(access$700, (float) (touchImageView.viewWidth / 2), (float) (TouchImageView.this.viewHeight / 2), true));
            }
        }
    }
    ...
    private class Fling implements Runnable {
        ...
        public void run() {
            ...
            if (this.scroller.isFinished()) {
                ...
                this.currX = currX2;
                this.currY = currY2;
                TouchImageView.this.matrix.postTranslate((float) (currX2 - this.currX), (float) (currY2 - this.currY));
                TouchImageView.this.fixTrans();
                TouchImageView touchImageView = TouchImageView.this;
                touchImageView.setImageMatrix(touchImageView.matrix);
                TouchImageView.this.compatPostOnAnimation(this);
