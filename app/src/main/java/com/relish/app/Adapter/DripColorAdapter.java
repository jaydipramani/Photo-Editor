...
public class DripColorAdapter extends RecyclerView.Adapter<DripColorAdapter.ViewHolder> {
    ...
    public DripColorAdapter(Context context2, ColorListener frameListener) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            DripColorAdapter.this.colorListener.onColorSelected(DripColorAdapter.this.squareViewList.get(DripColorAdapter.this.selectedSquareIndex));
