...
public class RecyclerTabLayout extends RecyclerView {
    ...
    public RecyclerTabLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        LinearLayoutManager r1 = new LinearLayoutManager(getContext()) {
        ...
        this.mLinearLayoutManager = r1;
        r1.setOrientation(HORIZONTAL);
    ...
    public void scrollToTab(int i, float f, boolean z) {
        ...
        if (findViewByPosition != null) {
            ...
            if (getMeasuredWidth() > 0 && (i2 = this.mTabMaxWidth) > 0 && this.mTabMinWidth == i2) {
                ...
                int measuredWidth5 = ((int) (((float) (-i4)) * f)) + ((int) (((float) (getMeasuredWidth() - i4)) / 2.0f));
            }
        ...
        stopScroll();
        if (!(i == this.mOldPosition && i22 == this.mOldScrollOffset)) {
            this.mLinearLayoutManager.scrollToPositionWithOffset(i, i22);
        }
        if (this.mIndicatorHeight > 0) {
            invalidate();
        }
        this.mOldPosition = i;
        this.mOldScrollOffset = i22;
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (findViewByPosition != null) {
            ...
            canvas.drawRect((float) i, (float) (getHeight() - this.mIndicatorHeight), (float) i2, (float) getHeight(), this.mIndicatorPaint);
