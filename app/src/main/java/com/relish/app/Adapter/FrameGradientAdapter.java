...
public class FrameGradientAdapter extends RecyclerView.Adapter<FrameGradientAdapter.ViewHolder> {
    ...
    public FrameGradientAdapter(Context context2, FrameListener frameListener2) {
        ArrayList arrayList = new ArrayList();
        this.squareViewList = arrayList;
        this.context = context2;
        this.frameListener = frameListener2;
        arrayList.add(new SquareView(R.drawable.gradient_0, "None"));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            FrameGradientAdapter.this.selectedSquareIndex = getAdapterPosition();
            FrameGradientAdapter.this.frameListener.onBackgroundSelected(FrameGradientAdapter.this.squareViewList.get(FrameGradientAdapter.this.selectedSquareIndex));
            FrameGradientAdapter.this.notifyDataSetChanged();
        }
    }
