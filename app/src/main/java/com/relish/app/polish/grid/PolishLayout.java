...
public interface PolishLayout {
    PolishLayout clone(PolishLayout polishLayout);

    Info generateInfo();

    PolishArea getArea(int i);
    ...
    PolishArea getOuterArea();

    List<PolishLine> getOuterLines();
    ...
    public static class Info implements Parcelable {
        ...
        public ArrayList<PolishLine> lines;
    ...
    public static class Step implements Parcelable {
        ...
        public PolishLine.Direction lineDirection() {
            return this.direction == 0 ? PolishLine.Direction.HORIZONTAL : PolishLine.Direction.VERTICAL;
        }
    ...
    public static class LineInfo implements Parcelable {
        ...
        public LineInfo(PolishLine line) {
