...
public class StraightUtils {
    ...
    static StraightLine createLine(StraightArea straightArea, PolishLine.Direction direction, float f) {
        ...
        } else if (direction == PolishLine.Direction.VERTICAL) {
    ...
    static List<StraightArea> cutArea(StraightArea straightArea, StraightLine straightLine) {
        ...
        if (straightLine.direction() == PolishLine.Direction.HORIZONTAL) {
        ...
        } else if (straightLine.direction() == PolishLine.Direction.VERTICAL) {
    ...
    static Pair<List<StraightLine>, List<StraightArea>> cutArea(StraightArea straightArea, int i, int i2) {
        ...
        for (int i4 = i + 1; i4 > 1; i4--) {
            StraightLine createLine = createLine(straightArea2, PolishLine.Direction.HORIZONTAL, ((float) (i4 - 1)) / ((float) i4));
        ...
        while (true) {
            ...
            StraightLine createLine2 = createLine(straightArea3, PolishLine.Direction.VERTICAL, ((float) (i5 - 1)) / ((float) i5));
