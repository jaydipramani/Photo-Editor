...
public class PolishColoredView extends ImageView {
    ...
    public void setColoredItems(ColoredAdapter.ColoredItems coloredItems2) {
        this.coloredItems = coloredItems2;
        if (coloredItems2.mode == ColoredAdapter.COLORED.SHADER) {
            this.bitmapPaint.setShader(new BitmapShader(BitmapFactory.decodeResource(getResources(), coloredItems2.shaderId), Shader.TileMode.REPEAT, Shader.TileMode.REPEAT));
        }
    }

    public PolishColoredView(Context context) {
        super(context);
        init();
    }
    ...
    public PolishColoredView(Context context, AttributeSet attributeSet, int i) {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.coloredItems.mode == ColoredAdapter.COLORED.COLOR_1 || this.coloredItems.mode == ColoredAdapter.COLORED.COLOR_2 || this.coloredItems.mode == ColoredAdapter.COLORED.COLOR_3 || this.coloredItems.mode == ColoredAdapter.COLORED.COLOR_4 || this.coloredItems.mode == ColoredAdapter.COLORED.COLOR_5 || this.coloredItems.mode == ColoredAdapter.COLORED.COLOR_6 || this.coloredItems.mode == ColoredAdapter.COLORED.COLOR_7 || this.coloredItems.mode == ColoredAdapter.COLORED.COLOR_8 || this.coloredItems.mode == ColoredAdapter.COLORED.COLOR_9 || this.coloredItems.mode == ColoredAdapter.COLORED.COLOR_10 || this.coloredItems.mode == ColoredAdapter.COLORED.COLOR_11 || this.coloredItems.mode == ColoredAdapter.COLORED.COLOR_12 || this.coloredItems.mode == ColoredAdapter.COLORED.COLOR_13 || this.coloredItems.mode == ColoredAdapter.COLORED.COLOR_14 || this.coloredItems.mode == ColoredAdapter.COLORED.COLOR_15 || this.coloredItems.mode == ColoredAdapter.COLORED.COLOR_16 || this.coloredItems.mode == ColoredAdapter.COLORED.COLOR_17 || this.coloredItems.mode == ColoredAdapter.COLORED.COLOR_18 || this.coloredItems.mode == ColoredAdapter.COLORED.COLOR_19) {
