...
public class SaturationSquareBackgroundFragment extends DialogFragment implements SplashSquareAdapter.SplashChangeListener {
    ...
    public static SaturationSquareBackgroundFragment show(AppCompatActivity appCompatActivity, Bitmap bitmap2, Bitmap bitmap3, Bitmap bitmap4, SplashSaturationBackgrundListener splashSaturationListener, boolean z) {
