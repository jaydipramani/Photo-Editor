...
public class MosaicAdapter extends RecyclerView.Adapter<MosaicAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        if (this.selectedSquareIndex == i) {
            viewHolder.mosaic.setBorderColor(ContextCompat.getColor(this.context, R.color.white));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View view) {
            ...
            this.constraintLayout = (ConstraintLayout) view.findViewById(R.id.constraintLayoutMosaic);
