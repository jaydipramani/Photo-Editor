...
public class PhotoGridAdapter extends SelectableAdapter<PhotoGridAdapter.PhotoViewHolder> {
    ...
    public PhotoViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        final PhotoViewHolder photoViewHolder = new PhotoViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_photo, viewGroup, false));
        if (i == 100) {
    ...
    public void onBindViewHolder(final PhotoViewHolder photoViewHolder, int i) {
        ...
        if (getItemViewType(i) == 101) {
            ...
            if (AndroidLifecycleUtils.canLoadImage(photoViewHolder.image_view_picker.getContext())) {
                ...
                ((RequestOptions) ((RequestOptions) ((RequestOptions) requestOptions.centerCrop()).dontAnimate()).override(i2, i2)).placeholder(R.drawable.image_show);
